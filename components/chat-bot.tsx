...
//         className="fixed bottom-4 right-4 p-4 rounded-full shadow-lg bg-blue-600 hover:bg-blue-700 text-white transition-all duration-300 z-50 flex items-center justify-center"
...
//       {/* Header */}
//       <div className="relative z-10 p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-800">
...
//           disabled={isLoading}
//           className="flex-1 px-4 py-2 rounded-full border border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200"
//         />
//         <button
//           type="submit"

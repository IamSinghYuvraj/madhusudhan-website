...
import { Play, Pause, ChevronLeft, ChevronRight, Star, Award, Shield, Zap } from "lucide-react";
...
const productMedia = [
  {
    type: "image",
    src: MineralWaterPlant1,
    alt: "Mineral Water Plant - Main View"
  },
  {
    type: "image", 
    src: MineralWaterPlant2,
    alt: "Packaged Drinking Water Plant"
  },
  {
    type: "image",
    src: MineralWaterPlant3,
    alt: "Complete Mineral Water Project"
  },
  {
    type: "video",
    src: "https://www.youtube.com/embed/dQw4w9WgXcQ",
    thumbnail: MineralWaterPlant1,
    alt: "Mineral Water Plant Operation Video"
  }
];
...
const features = [
  ...
  },
  {
    ...
    description: "25+ years of expertise in water treatment solutions"
  },
  {
    icon: <Shield className="w-6 h-6" />,
    title: "Reliable & Safe",
    description: "Advanced safety features and reliable operation"
  },
  {
    icon: <Zap className="w-6 h-6" />,
    title: "Energy Efficient",
    description: "Optimized for minimal energy consumption"
  }
];
...
const specifications = [
  ...
  { label: "Automation", value: "Fully Automatic / Semi Automatic" },
  { label: "Power Supply", value: "220V / 440V, 50Hz" },
  { label: "Warranty", value: "2 Years Comprehensive" },
  { label: "Installation", value: "Complete Turnkey Solution" }
];

export default function MineralWaterPlantsPage() {
          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-white/80 mb-8 leading-relaxed">
                State-of-the-art mineral water treatment plants designed for 
                premium quality water production with advanced purification technology.
              </p>
              <motion.div
              ...
              >
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white px-8 py-4 text-lg rounded-full shadow-2xl"
                >
                  Get Quote
                </Button>
              </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-4xl font-light text-gray-900 mb-4">
              Why Choose Our 
              <span className="font-bold text-blue-600"> Mineral Water Plants</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the perfect blend of innovation, reliability, and efficiency
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className="h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-500 bg-gradient-to-br from-white to-slate-50">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Engineered with precision and built to last, our mineral water plants 
                deliver consistent performance and exceptional water quality.
              </p>

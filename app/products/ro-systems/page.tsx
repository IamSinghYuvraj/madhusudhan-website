          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <p className="text-xl text-white/80 mb-8 leading-relaxed">
                Advanced reverse osmosis systems delivering pure, safe water 
                with cutting-edge membrane technology and intelligent controls.
              </p>
              <motion.div
        ...
        <div className="container mx-auto px-6">
          ...
          >
            <h2 className="text-4xl font-light text-gray-900 mb-4">
              Advanced 
              <span className="font-bold text-blue-600"> RO Technology</span>
            </h2>

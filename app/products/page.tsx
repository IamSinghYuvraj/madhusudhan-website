        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-white p-6 rounded-lg w-11/12 max-w-md max-h-[80vh] overflow-y-auto">
            ...
            <table className="w-full">
              <tbody>
                <tr>
                  <td className="py-2 font-semibold">Minimum Order</td>
                  <td className="py-2">
                ...
                <tr>
                  ...
                  <td className="py-2">{selectedProduct.delivery_time}</td>
                </tr>
                <tr>
                  <td className="py-2 font-semibold">Features</td>
                  <td className="py-2">{selectedProduct.features}</td>
                </tr>
                <tr>
                  <td className="py-2 font-semibold">Applications</td>
                  <td className="py-2">{selectedProduct.applications}</td>
                </tr>
                {selectedProduct.specifications && (
                  <tr>
                    <td className="py-2 font-semibold">Specifications</td>
                    <td className="py-2">{selectedProduct.specifications}</td>
                  </tr>
                )}
              </tbody>
            </table>
